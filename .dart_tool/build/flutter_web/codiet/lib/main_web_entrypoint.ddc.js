define(['dart_sdk', 'packages/codiet/main'], function(dart_sdk, packages__codiet__main) {
  'use strict';
  ...
  const main = packages__codiet__main.main;
  ...
  dart.trackLibraries("packages/codiet/main_web_entrypoint", {
    "package:codiet/main_web_entrypoint.dart": main_web_entrypoint
  }, {
