...
let modulePaths = {
 ...
 "packages/codiet/main": "packages/codiet/main.ddc",
 "packages/codiet/main_web_entrypoint": "packages/codiet/main_web_entrypoint.ddc",
 "packages/codiet/models/UserInfo": "packages/codiet/models/UserInfo.ddc",
 "packages/codiet/models/WeightSeries": "packages/codiet/models/WeightSeries.ddc",
 "packages/codiet/pages/auth_page": "packages/codiet/pages/auth_page.ddc",
 "packages/codiet/pages/data_page": "packages/codiet/pages/data_page.ddc",
 "packages/codiet/pages/home_page": "packages/codiet/pages/home_page.ddc",
 "packages/codiet/pages/journey_page": "packages/codiet/pages/journey_page.ddc",
 "packages/codiet/pages/profile_page": "packages/codiet/pages/profile_page.ddc",
 "packages/codiet/pages/root_page": "packages/codiet/pages/root_page.ddc",
 "packages/codiet/utils/auth": "packages/codiet/utils/auth.ddc",
 "packages/codiet/utils/centered_view": "packages/codiet/utils/centered_view.ddc",
 "packages/codiet/utils/custom_dialog": "packages/codiet/utils/custom_dialog.ddc",
 "packages/codiet/utils/responsive_widget": "packages/codiet/utils/responsive_widget.ddc",
 "packages/codiet/utils/weight_chart": "packages/codiet/utils/weight_chart.ddc",
 ...
 "packages/firebase/firebase_io": "packages/firebase/firebase_io.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/codiet/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:codiet/main_web_entrypoint.dart") {
          // Clear static caches.
